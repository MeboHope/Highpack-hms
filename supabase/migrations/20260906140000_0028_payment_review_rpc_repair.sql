-- Repair the admin payment review RPC for databases where the original
-- payment-review migration was not applied or the function was lost.
-- This is intentionally idempotent and preserves the existing RLS model.
