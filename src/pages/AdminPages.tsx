...
export function AdminPropertyDetail({ propertyId }: { propertyId: string }) {
  ...
  return <DashboardLayout navItems={adminNav} title="Property inspection">
    ...
    <div className="overflow-hidden rounded-3xl border border-ink-100 bg-white shadow-soft-lg">
      ...
      <div className="grid grid-cols-2 gap-px bg-ink-100 sm:grid-cols-4"><div className="bg-white p-4"><p className="text-2xl font-bold text-ink-900">{units.length}</p><p className="text-xs text-ink-500">Total units</p></div><div className="bg-white p-4"><p className="text-2xl font-bold text-brand-700">{occupancy}%</p><p className="text-xs text-ink-500">Occupancy</p></div><div className="bg-white p-4"><p className="text-2xl font-bold text-ink-900">{leases.length}</p><p className="text-xs text-ink-500">Recent leases</p></div><div className="bg-white p-4"><p className="text-2xl font-bold text-ink-900">{reservations.length}</p><p className="text-xs text-ink-500">Recent reservations</p></div></div>
    </div>
