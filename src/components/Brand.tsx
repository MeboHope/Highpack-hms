  ...
  return (
    ...
    >
      ...
      <span className="block min-w-0">
        <span className={compact
          ? 'block truncate text-[12px] font-extrabold leading-tight tracking-[0.09em] text-brand-950 sm:text-[15px]'
        ...
        <span className={compact
          ? 'mt-0.5 block truncate text-[8px] font-semibold uppercase tracking-[0.2em] text-ink-500 sm:text-[10px]'
          : 'mt-0.5 block text-[10px] font-semibold uppercase tracking-[0.22em] text-ink-500'}>Consult Ltd</span>
        <span className={compact
          ? 'mt-0.5 block truncate text-[6px] font-bold uppercase tracking-[0.12em] text-brand-700 sm:text-[8px] sm:tracking-[0.18em]'
          : 'mt-1 block text-[8px] font-bold uppercase tracking-[0.18em] text-brand-700'}>Strategy • Solutions • Success</span>
      </span>
    </Link>
  );
}
